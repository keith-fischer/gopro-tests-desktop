...
::GDAinstaller64.exe
::%SIKULI_HOME%
cd C:\Automation\gopro-tests-desktop\GDA\sikuli\gda_create_tests.sikuli
...
FOR /L %%A IN (1,1,1) DO (
  %%A
  java -jar "C:\Program Files (x86)\sikuli\sikulix.jar" -r C:\Automation\gopro-tests-desktop\GDA\sikuli\gda.sikuli --args "gda_create_tests-regression" "Quik2.0.0.3784"
