...
::java -jar "C:\Program Files (x86)\sikuli\sikulix.jar" -r C:\Automation\gopro-tests-desktop\GDA\sikuli\gda.sikuli --args gda_create_tests-record
...
cd %gdapath%\python\testrail
set py="C:\Python27\python"
%py% -V
cd %gdapath%\python\testrail
:: start %py%\python %gdapath%\python\testrail\restservertestrail.py
START "restservertestrail" %py% %gdapath%\python\testrail\restservertestrail.py
:: %py% %gdapath%\python\testrail\restservertestrail.py
::timeout 5

FOR /L %%A IN (1,1,100) DO (
  ========================================
  %%A
  %gdapath%\GDASetAppWindow64.exe
  cd %gdapath%\sikuli\gda_music_tests.sikuli
  java -jar "C:\Program Files (x86)\sikuli\sikulix.jar" -r %gdapath%\sikuli\gda.sikuli --args "gda_create_tests-record" "Songs_Regression_Win81_SurfaceP3_i7_Quik210_4643-PROD"
